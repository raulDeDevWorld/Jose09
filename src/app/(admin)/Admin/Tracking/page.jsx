...

                        {
                            userDB && userDB[`tracking`] && Object.entries(userDB[`tracking`]).map((i, index) => {
                                return <div className='relative p-5 my-5 mt-10 bg-white space-y-5 shadow-2xl border-b-[.5px] border-[#666666] '>
                                    ...
                                    < InputFlotante type="text" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data']} required label={'data'} shadow='shadow-white' />
                                    < InputFlotante type="text" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data1']} required label={'data1'} shadow='shadow-white' />
                                    < InputFlotante type="number" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data2']} required label={'data2'} shadow='shadow-white' />
                                    < InputFlotante type="number" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data3']} required label={'data3'} shadow='shadow-white' />
                                    < InputFlotante type="text" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data4']} required label={'data4'} shadow='shadow-white' />
                                    < InputFlotante type="text" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data5']} required label={'data5'} shadow='shadow-white' />
                                    < InputFlotante type="text" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data6']} required label={'data6'} shadow='shadow-white' />
                                    < InputFlotante type="number" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data7']} required label={'data7'} shadow='shadow-white' />
                                    < InputFlotante type="number" id="floating_5" onChange={(e) => handlerOnChange(e, i[0])} defaultValue={i[1]['data8']} required label={'data8'} shadow='shadow-white' />
